...
1. MemoListWindow 便签列表窗口：显示便签列表，新建、删除便签
2. MemoWindow 便签窗口：文字排版、插入图片、新建便签
"""
...
class MemoListWindow(QMainWindow):
    ...
    def set_tool_bar(self):
        ...
        # 新建便签
        self.new_action = QAction(QIcon("icon/plus-circle.png"), "新建<br>Ctrl+N", self)
        self.new_action.setShortcut("Ctrl+N")
        self.new_action.triggered.connect(self.new_memo)
        self.tool_bar.addAction(self.new_action)

        # 删除便签
        self.delete_action = QAction(QIcon("icon/x-circle.png"), "删除<br>Del", self)
    ...
    def new_memo(self):
        ...
        # 将这个便签加入MemoApp字典
        memo_window = MemoWindow(self.selected_memo, self.memo_app)
...
class MemoWindow(QMainWindow):
    ...
    def __init__(self, memo_name, memo_app):
        super().__init__()
    ...
    def set_tool_bar(self):
        ...
        # 粗体
        self.bold_action = QAction(QIcon("icon/type-bold.png"), "粗体<br>Ctrl+B", self)
        ...
        # 字体
        self.font_color_action = QAction(QIcon("icon/palette.png"), "字体颜色", self)
        ...
        self.font_size_box.setStyleSheet("QSpinBox { width: 50px; height: 28px; }")
        ...
        self.open_memo_list_window_action.triggered.connect(self.open_memo_list_window)
    ...
    def add_image(self):
        ...
        if image_file:
            ...
            # 添加到便签信息
            self.memo_app.memo_info[self.memo_name]["image"].append(new_image_filename)
    ...
    def new_memo(self):
        ...
        # 将这个便签加入MemoApp字典
        memo_window = MemoWindow(file_name, self.memo_app)
                ...
                if self.memo_app.is_memo_list_open:
                    ...
                    for i in range(self.memo_app.memo_list_window.memo_list.count()):
                        ...
                        if (
                            ...
                            # 在便签列表删除便签项
                            self.memo_app.memo_list_window.memo_list.takeItem(i)
                            break
